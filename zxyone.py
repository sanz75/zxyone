...
\033[1;97m ╚═════════════════════════════════════╝
\033[1;97m ╔═════════════════════════════════════╗
\033[1;97m ║ Author : Moch Haris Snowsky XD.                 ║
\033[1;97m ║ Github : https://github.com/sanz75 ║
\033[1;97m ╚═════════════════════════════════════╝ """
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://m.facebook.com/MochHarisSnowskyXD')
		menu()
	except KeyError:
